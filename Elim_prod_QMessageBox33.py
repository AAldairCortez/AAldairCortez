...
from PyQt5.QtWidgets import QApplication, QLabel, QMainWindow, QMessageBox, QPushButton, QLineEdit
...
class EliminacionProductoVentana(QMainWindow):
    ...
    def elimar_producto(self):
        confirmacion = QMessageBox()
        confirmacion.setText('Estas seguro de querer elimar este producto?')
        ...
        if confirmacion.clickedBurron() == boton_yes:
